...
use Drupal\d8_services_di\Services\Notifier\NotifierInterface;
 ...
 * 
 * @package Drupal\d8_services_di\Services\Subscriber
 */
class SubscriberManager implements SubscriberManagerInterface {
	...
	public function getSubscribers() {
		...
		$result[] = (object) ['first_name' => 'Drupal8', 'email' => 'drupal8@test.com'];
		return $result;
	}

...
use Drupal\d8_custom_block\Services\GoogleBook\GoogleBookManagerInterface;
...
class GoogleBookBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface {
	 ...
	 * Google book manager.
	 * 
	 * @var \Drupal\d8_custom_block\Services\GoogleBook\GoogleBookManagerInterface
	 */
	 ...
	 * 
	 * @param \Drupal\d8_custom_block\Services\GoogleBook\GoogleBookManagerInterface $google_book_manager
   ...
   */
	public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
		return new static(
			...
			$plugin_id,
			$plugin_definition,
			$container->get('d8_custom_block.google_book_manager')
		);
	}
